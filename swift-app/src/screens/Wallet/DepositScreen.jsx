        ...
        <View style={styles.centered}>
          ...
          <Text style={{ color: theme.textMuted, marginBottom: 20 }}>
            {method === 'Bank Transfer'
              ? 'Transfer completed to your wallet'
              : `₦${amount} deposited via ${method}`}
          </Text>
          <TouchableOpacity
        ...
        <>
          ...
          <View style={[styles.dropdown, { borderColor: theme.border }]}>
            {['Bank Transfer', 'Card', 'USSD'].map((m) => (
              <TouchableOpacity
                ...
                style={[
                  styles.option,
                  { backgroundColor: method === m ? theme.lightGray : 'transparent' },
                ]}
                onPress={() => setMethod(m)}
              >
                <Ionicons
                  name={m === 'Bank Transfer' ? 'business' : m === 'Card' ? 'card' : 'keypad'}
                  size={18}
                  color={theme.primary}
                />
          ...
          {method === 'Bank Transfer' ? (
            <View style={[styles.accountBox, { borderColor: theme.border }]}>
              ...
              <Text style={[styles.accountLabel, { color: theme.textMuted, marginTop: 10 }]}>
                Account Number
              </Text>
              ...
              <Text style={{ color: theme.textMuted, fontSize: 12, marginTop: 8 }}>
                Transfer to this account and it will reflect in your wallet
              </Text>
            </View>
          ) : (
            <>
