...
const NETWORKS = [
  {
    ...
    plans: [
      { id: '1gb', label: '1GB - ₦300', price: 300 },
      { id: '2gb', label: '2GB - ₦500', price: 500 },
      { id: '5gb', label: '5GB - ₦1200', price: 1200 },
    ],
  },
  {
    id: 'airtel',
    ...
    plans: [
      { id: '1gb', label: '1GB - ₦350', price: 350 },
      { id: '2gb', label: '2GB - ₦600', price: 600 },
      { id: '5gb', label: '5GB - ₦1300', price: 1300 },
    ],
  },
  {
    id: 'glo',
    ...
    plans: [
      { id: '1gb', label: '1GB - ₦280', price: 280 },
      { id: '2gb', label: '2GB - ₦500', price: 500 },
      { id: '5gb', label: '5GB - ₦1000', price: 1000 },
    ],
  },
  {
    id: '9mobile',
    ...
    plans: [
      { id: '1gb', label: '1GB - ₦400', price: 400 },
      { id: '2gb', label: '2GB - ₦700', price: 700 },
      { id: '5gb', label: '5GB - ₦1500', price: 1500 },
    ],
  },
];
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      <View style={styles.topBar}>
        ...
        <Text style={[styles.title, { color: theme.primary }]}>Data</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      {success ? (
        <View style={styles.centered}>
          ...
          <Text style={[styles.successText, { color: theme.primary }]}>Data Purchase Successful</Text>
          <Text style={{ color: theme.textMuted, marginBottom: 20 }}>
            {plan?.label} sent to {phone} ({network?.name})
          </Text>
          <TouchableOpacity
        ...
        <>
          ...
          {network && (
            <>
              <Text style={[styles.label, { color: theme.primary }]}>Data Plan</Text>
              <TouchableOpacity
                style={[styles.dropdown, { borderColor: theme.border }]}
                onPress={() => setShowPlanOptions(!showPlanOptions)}
              >
                {plan ? (
                  <Text style={[styles.optionText, { color: theme.primary }]}>{plan.label}</Text>
                ) : (
                  <Text style={{ color: theme.textMuted }}>Select Plan</Text>
                )}
                <Ionicons
              ...
              {showPlanOptions &&
                network.plans.map((p) => (
                  ...
                  >
                    <Text style={[styles.optionText, { color: theme.primary }]}>{p.label}</Text>
                  </TouchableOpacity>
                ))}
            </>
          )}
